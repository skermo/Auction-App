    ...
    <div>
      <div className="terms-and-conditions">
        ...
        <p>
          ...
          shall manage your use of our website, Auction App.
        </p>
        ...
        <p>
          Other than the content you own, under these Terms, Auction App and/or
        ...
        <p>
          ...
          and Auction App may further restrict access by you to any areas of
        ...
        <p>
          ...
          App a non-exclusive, worldwide irrevocable, sub licensable license to
        ...
        <p>
          ...
          third-party’s rights. Auction App reserves the right to remove any of
        ...
        <p>
          This Website is provided "as is," with all faults, and Auction App
        ...
        <p>
          In no event shall Auction App, nor any of its officers, directors and
          ...
          under contract.  Auction App, including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extent Auction App from and
        ...
        <p>
          Auction App is permitted to revise these Terms at any time as it sees
        ...
        <p>
          The Auction App is allowed to assign, transfer, and subcontract its
        ...
        <p>
          These Terms constitute the entire agreement between Auction App and
